...
# Certificates
if [[ ! -d /srv/nucleus/config/certificates/ ]]; then
    mkdir -p /srv/nucleus/config/certificates/
fi

if [[ ! -f /srv/nucleus/config/certificates/nucleus.bundle.crt ]]; then
	cd /srv/nucleus/config/certificates/
...
if [[ ! -f /home/nucleus/.ssh/id_rsa && -f /srv/nucleus/config/certificates/identity.key ]]; then
	cp /srv/nucleus/config/certificates/identity.key /home/nucleus/.ssh/id_rsa
